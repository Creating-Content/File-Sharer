...
  shareCode: string | null; // Changed port to shareCode (string)
}

export default function InviteCode({ shareCode }: InviteCodeProps) {
...
        Share this unique code with anyone to allow them to download the file:
      </p>
      
...
        This code will be valid until you delete the file from your profile.
      </p>
    </div>
  );
}